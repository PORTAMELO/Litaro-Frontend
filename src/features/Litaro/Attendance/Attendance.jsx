...
const Attendance = () => {
  ...
  const selectedSubject = mockFilters.subjects.find((subject) => subject.id === filters.subject);
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Consulta y registra la asistencia de los estudiantes.</p>
        </div>
      </div>

      <section className={styles.filtersCard}>
        <Typography className={styles.sectionTitle}>Seleccionar clase</Typography>
        ...
        <div className={styles.tableHeader}>
          <div>
            ...
            <Typography className={styles.tableSubtitle}>
              {selectedClassroom?.name} · {selectedSubject?.name} · {filters.date}
            </Typography>
          </div>
                ...
                <tr key={student.id}>
                  ...
                  <td>
                    <TextField
                      ...
                      onChange={(e) => handleStudentChange(student.id, "observation", e.target.value)}
                      sx={{
                        "& input": {
                          fontFamily: "inherit",
                          fontSize: "var(--text-sm)",
